...
# following code is not good as it needs a library we cannot use for the coursework
# look at this: https://nathanrooy.github.io/posts/2016-08-17/simple-particle-swarm-optimization-with-python/
...
2. Implement PSO algorithm.
3. Use the PSO to optimize ANN parameters.
...
import numpy as np
np.random.seed(100) #we do this for reproducibility of our random data generated

# data generation for our ANN (just to test it)
...
# Iterative optimization ---> does not work.. does not give me same reults
